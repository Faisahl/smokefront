...
const Hero: React.FC = () => {
  return (
    <div className="md:relative -z-10 flex flex-col items-center mx-auto lg:flex-row-reverse lg:max-w-5xl lg:mt-12 xl:max-w-6xl">
      ...
      <div className="max-w-lg rounded-md bg-white md:max-w-2xl md:z-10 md:shadow-lg md:absolute md:top-0 md:mt-48 lg:w-3/5 lg:left-0 lg:mt-20 lg:ml-20 xl:mt-24 xl:ml-12">
        <div className="flex flex-col p-12 md:px-16">
          ...
          <h3 className="text-xl lg:text-2xl my-1 font-medium">
