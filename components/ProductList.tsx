...
const ProductList = async ({ path }: Props) => {
  ...
  return (
    <section id='Products' className="w-fit mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-items-center justify-center gap-y-20 gap-x-14 pt-10 mb-5" >
