    ...
    <section className="text-gray-700 body-font border-t border-gray-200">
        <div className="container px-5 py-20 mx-auto flex flex-wrap">
            ...
            <div className="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-12 lg:text-left text-center my-10">
                <div className="flex flex-col mb-10 lg:items-start items-center light:text-gray-900 dark:text-white">
            ...
            <div className="flex flex-col mb-10 lg:items-start items-center my-10 light:text-gray-900 dark:text-white">
                <div className="flex-grow">
